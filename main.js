...
import { AlternationToken, BracketToken, CharacterToken, GroupToken, OptionalToken } from "./tokens";
...
at index ${startIndex}`);
          ...
          // const charTokens = groupChars.map(c => new CharacterToken(c));
      ...
      case "|":
        {
          ...
          // console.log(chars.slice(startIndex, endIndex + 1));
      ...
      default:
        {
          const token = new CharacterToken(char);
          tokens.push(token);
        }
        break;
    }
